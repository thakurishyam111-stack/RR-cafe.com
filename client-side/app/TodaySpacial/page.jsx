      ...
      <main className="mx-auto max-w-7xl px-5 py-10 sm:px-8 lg:px-10">
        ...
        <section className="mt-14">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/Menu"
              className="hidden rounded-full border border-slate-300 px-5 py-2 text-sm font-medium transition hover:bg-slate-950 hover:text-white sm:block"
            >
              View Full Menu
            </Link>
          </div>
            ...
            {specials.map((item) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    href="/Order"
                    className="  inline-flex items-center justify-center rounded-full bg-green-600 px-8 py-4 text-xl font-bold transition hover:scale-105"
                  >
                    Order now
                  </Link>
                </div>
