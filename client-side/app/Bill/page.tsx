...
export default function BillPage() {
  ...
  const handlePayment = async (method) => {
    ...
    if (method === "Cash") {
      try {
        const res = await axios.put(
          `http://localhost:8080/api/orders/payment/${order._id}`,
          {
            method,
          },
        );
    ...
    if (appUrl) {
      ...
      alert(
        `Opening ${method}. If the app is installed, it may open automatically.`,
      );
    } else {
          ...
          {order.status !== "approved" ? (
            ...
            <>
              ...
              {order.paymentStatus !== "paid" && (
                <div className="mt-5">
                  <p className="text-xl text-center mb-3 text-gray-100">
                    Pay via
                  </p>
                  ...
                  <div className="flex justify-center gap-6">
                    ...
                    >
                      <img
                        src={
                          "https://thumbs.dreamstime.com/b/money-transaction-vector-logo-icon-design-buying-cash-symbol-illustration-illustrations-152825421.jpg"
                        }
                        width={60}
                        height={60}
                        alt="cash"
